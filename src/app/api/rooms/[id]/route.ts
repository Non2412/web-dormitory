...
export async function GET(request: Request, { params }: { params: Promise<{ id: string }> }) {
    ...
    const rooms: Record<string, unknown> = {
        '1': {
            ...
            price: 4500,
            status: 'AVAILABLE',
            dormitory: { id: '1', name: 'ห้องขนาดเล็ก' },
            image: '/room1.jpg',
            ...
            details: ["ห้องมีสไตล์โดเมสติก ตกแต่งอย่างเรียบร้อย", "ระบบแสงสว่างดี มีหน้าต่างให้อากาศหมุนเวียน", "ตู้เสื้อผ้าบิวท์อิน ทำให้เนื้อที่ว่างมากขึ้น", "เหมาะสำหรับคนรักษณภาพ และผู้ชื่นชอบพื้นที่กะทัดรัด", "ใกล้สิ่งอำนวยความสะดวกในหอพัก"]
        },
        '2': {
            id: '2',
            ...
            price: 6500,
            status: 'AVAILABLE',
            dormitory: { id: '2', name: 'ห้องขนาดกลาง' },
            image: '/room2.jpg',
            ...
            details: ["ห้องสว่าง มีประตูเปิดออกไปยังระเบียง", "พื้นปูด้วยปูนเรียบสีขาว ทำให้ห้องดูกว้างขวาง", "ตู้เสื้อผ้าแบบหลายช่องเก็บของได้เยอะ", "พื้นที่นั่งพักผ่อนพอเหมาะ", "โทรทัศน์ขนาดกลาง เหมาะสำหรับดูหนัง"]
        },
        '3': {
            id: '3',
            ...
            price: 8500,
            status: 'AVAILABLE',
            dormitory: { id: '3', name: 'ห้องขนาดใหญ่' },
            image: '/room3.jpg',
            ...
            details: ["ห้องกว้างขวาง มีเตียงนอนคู่พร้อมเตียงเสริม", "พื้นลามิเนตแบบลายไม้ ทำให้ห้องดูอบอุ่นและหรูหรา", "แสงสว่างจากหน้าต่างกว้าง ระเบียงให้ทัศนียวิทยา", "ทีวีขนาดใหญ่พร้อมสัญญาณชัดเจน", "ตู้เสื้อผ้าจำนวนมาก พื้นที่เก็บของเพียงพอ", "เหมาะสำหรับกลุ่มเพื่อน หรือ ครอบครัวเล็ก"]
        }
    };
